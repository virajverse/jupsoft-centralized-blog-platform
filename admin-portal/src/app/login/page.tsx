            ...
            <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-1.5">
                <button
                  type="button"
                  onClick={() => {
                    setEmail('aarav.sharma@jupsoft.com');
                    setPassword('Jupsoft@2026!Admin');
                  }}
                  className="px-2.5 py-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 dark:bg-slate-900 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 text-left transition-colors cursor-pointer"
                >
                  <div className="text-[11px] font-bold text-slate-800 dark:text-slate-200">Super Admin</div>
                  <div className="text-[9px] text-slate-400 truncate">aarav.sharma</div>
                </button>
                <button
                  type="button"
                  onClick={() => {
                    setEmail('priya.verma@jupsoft.com');
                    setPassword('Jupsoft@4829!Priya');
                  }}
                  className="px-2.5 py-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 dark:bg-slate-900 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 text-left transition-colors cursor-pointer"
                >
                  <div className="text-[11px] font-bold text-slate-800 dark:text-slate-200">Editor</div>
                  <div className="text-[9px] text-slate-400 truncate">priya.verma</div>
                </button>
                <button
                  type="button"
                  onClick={() => {
                    setEmail('vikram.mehta@jupsoft.com');
                    setPassword('Jupsoft@8192!Vikram');
                  }}
                  className="px-2.5 py-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 dark:bg-slate-900 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 text-left transition-colors cursor-pointer"
                >
                  <div className="text-[11px] font-bold text-slate-800 dark:text-slate-200">SEO Manager</div>
                  <div className="text-[9px] text-slate-400 truncate">vikram.mehta</div>
                </button>
                <button
                  type="button"
                  onClick={() => {
                    setEmail('rohan.gupta@jupsoft.com');
                    setPassword('Jupsoft@5314!Rohan');
                  }}
                  className="px-2.5 py-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 dark:bg-slate-900 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 text-left transition-colors cursor-pointer"
                >
                  <div className="text-[11px] font-bold text-slate-800 dark:text-slate-200">Publisher</div>
                  <div className="text-[9px] text-slate-400 truncate">rohan.gupta</div>
                </button>
              </div>
            </div>
          </form>
