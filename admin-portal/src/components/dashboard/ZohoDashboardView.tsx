        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {canAccessModule(activeRole, 'workflow') && (
            <Link
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1 rounded bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-semibold text-[11px] border border-slate-200 dark:border-slate-700 transition-colors"
            >
              <Kanban className="w-3 h-3 text-amber-500" />
              <span>Kanban (${underReviewBlogs.length})</span>
            </Link>
          )}
          ...
          <Link
            ...
            className="inline-flex items-center gap-1 px-2.5 py-1 rounded bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-semibold text-[11px] border border-slate-200 dark:border-slate-700 transition-colors"
          >
            <span>All Blogs (${displayedBlogs.length})</span>
