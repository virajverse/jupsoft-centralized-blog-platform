...
# Usage:
#   bash deploy-vps.sh            -> Smart quick update (Git diff, zero downtime)
#   bash deploy-vps.sh --update   -> Fast pull, build changes only & reload
#   bash deploy-vps.sh --clean    -> Deep clean rebuild of all caches
# ==============================================================================
